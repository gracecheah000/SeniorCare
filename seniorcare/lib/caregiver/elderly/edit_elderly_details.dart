...
import 'package:seniorcare/widgets/elderly_card.dart';
                        ...
                        children: <Widget>[
                          Stack(children: <Widget>[
                            Container(
                                ...
                                decoration: const BoxDecoration(
                                    color: Color.fromARGB(255, 176, 200, 233),
                                    borderRadius: BorderRadius.only(
                                        bottomLeft: Radius.circular(80)))),
                            Padding(
                                padding:
                                    EdgeInsets.only(left: size.width * 0.11),
                                child: Row(
                          ...
                          ...snapshot.data!.map((elderly) => Padding(
                              ...
                              child: ElderlyDetailsCard(
                                elderly: elderly,
                                caregiverEmail: widget.caregiverData['email'],
