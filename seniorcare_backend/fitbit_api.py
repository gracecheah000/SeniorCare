...
import libs.fitbit as lib_fitbit
from libs.fitbit import gather_keys_oauth2 as Oauth2
import pandas as pd
import datetime 
...
auth2_client = lib_fitbit.Fitbit(CLIENT_ID, CLIENT_SECRET, oauth = True, access_token= ACCESS_TOKEN, refresh_token= REFRESH_TOKEN)
